...
func NewPutCustomersCustomerFidExternalReferenceParams() *PutCustomersCustomerFidExternalReferenceParams {
	return NewPutCustomersCustomerFidExternalReferenceParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidExternalReferenceParams].
