...
func NewPostCustomersCustomerFidPhonesParams() *PostCustomersCustomerFidPhonesParams {
	return NewPostCustomersCustomerFidPhonesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostCustomersCustomerFidPhonesParams].
