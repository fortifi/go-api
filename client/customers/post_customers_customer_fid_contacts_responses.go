...
func (o *PostCustomersCustomerFidContactsDefaultBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postCustomersCustomerFidContactsDefaultBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostCustomersCustomerFidContactsDefaultBodyAO1); err != nil {
		return err
	}
...
func (o PostCustomersCustomerFidContactsDefaultBody) MarshalJSON() ([]byte, error) {
	...
	postCustomersCustomerFidContactsDefaultBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostCustomersCustomerFidContactsDefaultBodyAO1, errPostCustomersCustomerFidContactsDefaultBodyAO1 := jsonutils.WriteJSON(dataPostCustomersCustomerFidContactsDefaultBodyAO1)
