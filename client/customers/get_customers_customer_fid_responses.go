...
func (o *GetCustomersCustomerFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidOKBodyAO1, errGetCustomersCustomerFidOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidOKBodyAO1)
