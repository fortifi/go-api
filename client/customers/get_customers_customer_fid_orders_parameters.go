...
func NewGetCustomersCustomerFidOrdersParams() *GetCustomersCustomerFidOrdersParams {
	return NewGetCustomersCustomerFidOrdersParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetCustomersCustomerFidOrdersParams].
...
func (o *GetCustomersCustomerFidOrdersParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IsLikeExternalReference != nil {
		...
		qIsLikeExternalReference := conv.FormatBool(qrIsLikeExternalReference)
