...
func (o *PostCustomersCustomerFidTicketsTicketFidPostsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostCustomersCustomerFidTicketsTicketFidPostsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postCustomersCustomerFidTicketsTicketFidPostsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostCustomersCustomerFidTicketsTicketFidPostsOKBodyAO1); err != nil {
		return err
	}
...
func (o PostCustomersCustomerFidTicketsTicketFidPostsOKBody) MarshalJSON() ([]byte, error) {
	...
	postCustomersCustomerFidTicketsTicketFidPostsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostCustomersCustomerFidTicketsTicketFidPostsOKBodyAO1, errPostCustomersCustomerFidTicketsTicketFidPostsOKBodyAO1 := jsonutils.WriteJSON(dataPostCustomersCustomerFidTicketsTicketFidPostsOKBodyAO1)
