...
func (o *PostCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowOK) Error() string {
	...
	return fmt.Sprintf("[POST /customers/{customerFid}/subscriptions/{subscriptionFid}/cancelFlow][%d] postCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowOK %s", 200, payload)
}
...
func (o *PostCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /customers/{customerFid}/subscriptions/{subscriptionFid}/cancelFlow][%d] PostCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlow default %s", o._statusCode, payload)
}
...
func (o *PostCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowOKBodyAO1); err != nil {
		return err
	}
...
func (o PostCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowOKBody) MarshalJSON() ([]byte, error) {
	...
	postCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowOKBodyAO1, errPostCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowOKBodyAO1 := jsonutils.WriteJSON(dataPostCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowOKBodyAO1)
