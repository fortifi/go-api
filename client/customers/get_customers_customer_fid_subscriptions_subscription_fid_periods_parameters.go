...
func NewGetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsParams() *GetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsParams {
	return NewGetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsParams].
