...
func NewGetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsParams() *GetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsParams {
	return NewGetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsParams].
...
func (o *GetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if err := r.SetPathParam("ticketPostTimestamp", conv.FormatInteger(o.TicketPostTimestamp)); err != nil {
		return err
	}
