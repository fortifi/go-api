...
func NewPutCustomersCustomerFidFraudParams() *PutCustomersCustomerFidFraudParams {
	return NewPutCustomersCustomerFidFraudParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidFraudParams].
