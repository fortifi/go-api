...
func (o *GetCustomersCustomerFidInvoicesInvoiceFidDownloadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidInvoicesInvoiceFidDownloadDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /customers/{customerFid}/invoices/{invoiceFid}/download][%d] GetCustomersCustomerFidInvoicesInvoiceFidDownload default %s", o._statusCode, payload)
}
...
func (o *GetCustomersCustomerFidInvoicesInvoiceFidDownloadOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidInvoicesInvoiceFidDownloadOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidInvoicesInvoiceFidDownloadOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidInvoicesInvoiceFidDownloadOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidInvoicesInvoiceFidDownloadOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidInvoicesInvoiceFidDownloadOKBodyAO1, errGetCustomersCustomerFidInvoicesInvoiceFidDownloadOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidInvoicesInvoiceFidDownloadOKBodyAO1)
