...
func NewPutCustomersCustomerFidChargebackParams() *PutCustomersCustomerFidChargebackParams {
	return NewPutCustomersCustomerFidChargebackParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidChargebackParams].
