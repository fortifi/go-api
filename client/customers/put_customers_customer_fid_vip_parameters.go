...
func NewPutCustomersCustomerFidVipParams() *PutCustomersCustomerFidVipParams {
	return NewPutCustomersCustomerFidVipParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidVipParams].
