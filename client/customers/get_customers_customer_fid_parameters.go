...
func NewGetCustomersCustomerFidParams() *GetCustomersCustomerFidParams {
	return NewGetCustomersCustomerFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetCustomersCustomerFidParams].
