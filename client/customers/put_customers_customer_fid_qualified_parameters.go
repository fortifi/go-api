...
func NewPutCustomersCustomerFidQualifiedParams() *PutCustomersCustomerFidQualifiedParams {
	return NewPutCustomersCustomerFidQualifiedParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidQualifiedParams].
