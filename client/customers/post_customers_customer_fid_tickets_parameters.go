...
func NewPostCustomersCustomerFidTicketsParams() *PostCustomersCustomerFidTicketsParams {
	return NewPostCustomersCustomerFidTicketsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostCustomersCustomerFidTicketsParams].
...
func (o *PostCustomersCustomerFidTicketsParams) bindParamAttachments(formats strfmt.Registry) []string {
	...
	attachmentsIS := stringutils.JoinByFormat(attachmentsIC, "")
