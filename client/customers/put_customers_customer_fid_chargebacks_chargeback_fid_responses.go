...
func (o *PutCustomersCustomerFidChargebacksChargebackFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putCustomersCustomerFidChargebacksChargebackFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutCustomersCustomerFidChargebacksChargebackFidOKBodyAO1); err != nil {
		return err
	}
...
func (o PutCustomersCustomerFidChargebacksChargebackFidOKBody) MarshalJSON() ([]byte, error) {
	...
	putCustomersCustomerFidChargebacksChargebackFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutCustomersCustomerFidChargebacksChargebackFidOKBodyAO1, errPutCustomersCustomerFidChargebacksChargebackFidOKBodyAO1 := jsonutils.WriteJSON(dataPutCustomersCustomerFidChargebacksChargebackFidOKBodyAO1)
