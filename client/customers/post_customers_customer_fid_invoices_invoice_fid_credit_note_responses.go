...
func (o *PostCustomersCustomerFidInvoicesInvoiceFidCreditNoteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostCustomersCustomerFidInvoicesInvoiceFidCreditNoteOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postCustomersCustomerFidInvoicesInvoiceFidCreditNoteOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostCustomersCustomerFidInvoicesInvoiceFidCreditNoteOKBodyAO1); err != nil {
		return err
	}
...
func (o PostCustomersCustomerFidInvoicesInvoiceFidCreditNoteOKBody) MarshalJSON() ([]byte, error) {
	...
	postCustomersCustomerFidInvoicesInvoiceFidCreditNoteOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostCustomersCustomerFidInvoicesInvoiceFidCreditNoteOKBodyAO1, errPostCustomersCustomerFidInvoicesInvoiceFidCreditNoteOKBodyAO1 := jsonutils.WriteJSON(dataPostCustomersCustomerFidInvoicesInvoiceFidCreditNoteOKBodyAO1)
