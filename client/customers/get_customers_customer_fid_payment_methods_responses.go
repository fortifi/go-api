...
func (o *GetCustomersCustomerFidPaymentMethodsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidPaymentMethodsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidPaymentMethodsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidPaymentMethodsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidPaymentMethodsOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidPaymentMethodsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidPaymentMethodsOKBodyAO1, errGetCustomersCustomerFidPaymentMethodsOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidPaymentMethodsOKBodyAO1)
