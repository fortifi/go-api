...
func NewPutCustomersCustomerFidSubscriptionsSubscriptionFidSetPaymentAccountParams() *PutCustomersCustomerFidSubscriptionsSubscriptionFidSetPaymentAccountParams {
	return NewPutCustomersCustomerFidSubscriptionsSubscriptionFidSetPaymentAccountParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidSubscriptionsSubscriptionFidSetPaymentAccountParams].
