...
func NewPutCustomersCustomerFidPaymentsPaymentFidRefundParams() *PutCustomersCustomerFidPaymentsPaymentFidRefundParams {
	return NewPutCustomersCustomerFidPaymentsPaymentFidRefundParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidPaymentsPaymentFidRefundParams].
...
func (o *PutCustomersCustomerFidPaymentsPaymentFidRefundParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	fTotalRefund := conv.FormatFloat(frTotalRefund)
	if fTotalRefund != "" {
