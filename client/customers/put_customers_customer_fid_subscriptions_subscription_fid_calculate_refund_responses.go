...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidCalculateRefundReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidCalculateRefundOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putCustomersCustomerFidSubscriptionsSubscriptionFidCalculateRefundOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutCustomersCustomerFidSubscriptionsSubscriptionFidCalculateRefundOKBodyAO1); err != nil {
		return err
	}
...
func (o PutCustomersCustomerFidSubscriptionsSubscriptionFidCalculateRefundOKBody) MarshalJSON() ([]byte, error) {
	...
	putCustomersCustomerFidSubscriptionsSubscriptionFidCalculateRefundOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutCustomersCustomerFidSubscriptionsSubscriptionFidCalculateRefundOKBodyAO1, errPutCustomersCustomerFidSubscriptionsSubscriptionFidCalculateRefundOKBodyAO1 := jsonutils.WriteJSON(dataPutCustomersCustomerFidSubscriptionsSubscriptionFidCalculateRefundOKBodyAO1)
