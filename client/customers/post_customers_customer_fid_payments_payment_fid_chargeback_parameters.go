...
func NewPostCustomersCustomerFidPaymentsPaymentFidChargebackParams() *PostCustomersCustomerFidPaymentsPaymentFidChargebackParams {
	return NewPostCustomersCustomerFidPaymentsPaymentFidChargebackParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostCustomersCustomerFidPaymentsPaymentFidChargebackParams].
...
func (o *PostCustomersCustomerFidPaymentsPaymentFidChargebackParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.FeeAmount != nil {
		...
		fFeeAmount := conv.FormatFloat(frFeeAmount)
		if fFeeAmount != "" {
	...
	fRefunded := conv.FormatBool(frRefunded)
	if fRefunded != "" {
