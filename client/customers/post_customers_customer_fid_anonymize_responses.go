...
func (o *PostCustomersCustomerFidAnonymizeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostCustomersCustomerFidAnonymizeOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postCustomersCustomerFidAnonymizeOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostCustomersCustomerFidAnonymizeOKBodyAO1); err != nil {
		return err
	}
...
func (o PostCustomersCustomerFidAnonymizeOKBody) MarshalJSON() ([]byte, error) {
	...
	postCustomersCustomerFidAnonymizeOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostCustomersCustomerFidAnonymizeOKBodyAO1, errPostCustomersCustomerFidAnonymizeOKBodyAO1 := jsonutils.WriteJSON(dataPostCustomersCustomerFidAnonymizeOKBodyAO1)
