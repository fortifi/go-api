...
func (o *PostCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchOptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchOptionsOK) Error() string {
	...
	return fmt.Sprintf("[POST /customers/{customerFid}/subscriptions/{subscriptionFid}/retentionFlow/{flowSearch}/options][%d] postCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchOptionsOK %s", 200, payload)
}
...
func (o *PostCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchOptionsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /customers/{customerFid}/subscriptions/{subscriptionFid}/retentionFlow/{flowSearch}/options][%d] PostCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchOptions default %s", o._statusCode, payload)
}
...
func (o *PostCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchOptionsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchOptionsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchOptionsOKBodyAO1); err != nil {
		return err
	}
...
func (o PostCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchOptionsOKBody) MarshalJSON() ([]byte, error) {
	...
	postCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchOptionsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
