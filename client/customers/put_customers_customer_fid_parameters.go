...
func NewPutCustomersCustomerFidParams() *PutCustomersCustomerFidParams {
	return NewPutCustomersCustomerFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidParams].
