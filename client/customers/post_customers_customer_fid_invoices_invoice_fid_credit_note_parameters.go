...
func NewPostCustomersCustomerFidInvoicesInvoiceFidCreditNoteParams() *PostCustomersCustomerFidInvoicesInvoiceFidCreditNoteParams {
	return NewPostCustomersCustomerFidInvoicesInvoiceFidCreditNoteParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostCustomersCustomerFidInvoicesInvoiceFidCreditNoteParams].
