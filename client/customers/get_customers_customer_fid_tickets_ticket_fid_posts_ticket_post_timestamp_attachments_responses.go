...
func (o *GetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsOKBodyAO1, errGetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidTicketsTicketFidPostsTicketPostTimestampAttachmentsOKBodyAO1)
