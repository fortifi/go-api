...
func NewDeleteCustomersCustomerFidPaymentMethodsCardsCardFidParams() *DeleteCustomersCustomerFidPaymentMethodsCardsCardFidParams {
	return NewDeleteCustomersCustomerFidPaymentMethodsCardsCardFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteCustomersCustomerFidPaymentMethodsCardsCardFidParams].
