...
func NewPutCustomersCustomerFidSubscriptionsSubscriptionFidCancelParams() *PutCustomersCustomerFidSubscriptionsSubscriptionFidCancelParams {
	return NewPutCustomersCustomerFidSubscriptionsSubscriptionFidCancelParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidSubscriptionsSubscriptionFidCancelParams].
