...
func NewPostCustomersCustomerFidNoteParams() *PostCustomersCustomerFidNoteParams {
	return NewPostCustomersCustomerFidNoteParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostCustomersCustomerFidNoteParams].
