...
func (o *PostCustomersCustomerFidSarReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostCustomersCustomerFidSarOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postCustomersCustomerFidSarOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostCustomersCustomerFidSarOKBodyAO1); err != nil {
		return err
	}
...
func (o PostCustomersCustomerFidSarOKBody) MarshalJSON() ([]byte, error) {
	...
	postCustomersCustomerFidSarOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostCustomersCustomerFidSarOKBodyAO1, errPostCustomersCustomerFidSarOKBodyAO1 := jsonutils.WriteJSON(dataPostCustomersCustomerFidSarOKBodyAO1)
