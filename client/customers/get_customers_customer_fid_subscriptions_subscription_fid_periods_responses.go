...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsOK) Error() string {
	...
	return fmt.Sprintf("[GET /customers/{customerFid}/subscriptions/{subscriptionFid}/periods][%d] getCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsOK %s", 200, payload)
}
...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /customers/{customerFid}/subscriptions/{subscriptionFid}/periods][%d] GetCustomersCustomerFidSubscriptionsSubscriptionFidPeriods default %s", o._statusCode, payload)
}
...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsOKBodyAO1, errGetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsOKBodyAO1)
