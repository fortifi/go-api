...
func NewPutCustomersCustomerFidLocationParams() *PutCustomersCustomerFidLocationParams {
	return NewPutCustomersCustomerFidLocationParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidLocationParams].
