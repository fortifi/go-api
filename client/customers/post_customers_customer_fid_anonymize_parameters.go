...
func NewPostCustomersCustomerFidAnonymizeParams() *PostCustomersCustomerFidAnonymizeParams {
	return NewPostCustomersCustomerFidAnonymizeParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostCustomersCustomerFidAnonymizeParams].
...
func (o *PostCustomersCustomerFidAnonymizeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Addresses != nil {
		...
		fAddresses := conv.FormatBool(frAddresses)
		if fAddresses != "" {
	...
	if o.Chats != nil {
		...
		fChats := conv.FormatBool(frChats)
		if fChats != "" {
	...
	if o.Customer != nil {
		...
		fCustomer := conv.FormatBool(frCustomer)
		if fCustomer != "" {
	...
	if o.Emails != nil {
		...
		fEmails := conv.FormatBool(frEmails)
		if fEmails != "" {
	...
	if o.Orders != nil {
		...
		fOrders := conv.FormatBool(frOrders)
		if fOrders != "" {
	...
	if o.PaymentAccounts != nil {
		...
		fPaymentAccounts := conv.FormatBool(frPaymentAccounts)
		if fPaymentAccounts != "" {
	...
	if o.Phones != nil {
		...
		fPhones := conv.FormatBool(frPhones)
		if fPhones != "" {
	...
	if o.Tickets != nil {
		...
		fTickets := conv.FormatBool(frTickets)
		if fTickets != "" {
