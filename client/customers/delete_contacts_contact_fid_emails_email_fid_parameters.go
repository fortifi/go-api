...
func NewDeleteContactsContactFidEmailsEmailFidParams() *DeleteContactsContactFidEmailsEmailFidParams {
	return NewDeleteContactsContactFidEmailsEmailFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteContactsContactFidEmailsEmailFidParams].
