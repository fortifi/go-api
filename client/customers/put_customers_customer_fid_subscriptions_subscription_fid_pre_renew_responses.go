...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidPreRenewReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidPreRenewOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putCustomersCustomerFidSubscriptionsSubscriptionFidPreRenewOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutCustomersCustomerFidSubscriptionsSubscriptionFidPreRenewOKBodyAO1); err != nil {
		return err
	}
...
func (o PutCustomersCustomerFidSubscriptionsSubscriptionFidPreRenewOKBody) MarshalJSON() ([]byte, error) {
	...
	putCustomersCustomerFidSubscriptionsSubscriptionFidPreRenewOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutCustomersCustomerFidSubscriptionsSubscriptionFidPreRenewOKBodyAO1, errPutCustomersCustomerFidSubscriptionsSubscriptionFidPreRenewOKBodyAO1 := jsonutils.WriteJSON(dataPutCustomersCustomerFidSubscriptionsSubscriptionFidPreRenewOKBodyAO1)
