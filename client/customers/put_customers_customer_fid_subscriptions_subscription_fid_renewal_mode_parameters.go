...
func NewPutCustomersCustomerFidSubscriptionsSubscriptionFidRenewalModeParams() *PutCustomersCustomerFidSubscriptionsSubscriptionFidRenewalModeParams {
	return NewPutCustomersCustomerFidSubscriptionsSubscriptionFidRenewalModeParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidSubscriptionsSubscriptionFidRenewalModeParams].
