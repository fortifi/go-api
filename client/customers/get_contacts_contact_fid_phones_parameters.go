...
func NewGetContactsContactFidPhonesParams() *GetContactsContactFidPhonesParams {
	return NewGetContactsContactFidPhonesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetContactsContactFidPhonesParams].
