...
func NewDeleteCustomersCustomerFidContactsContactFidParams() *DeleteCustomersCustomerFidContactsContactFidParams {
	return NewDeleteCustomersCustomerFidContactsContactFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteCustomersCustomerFidContactsContactFidParams].
