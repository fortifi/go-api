...
func NewPutCustomersCustomerFidSubscriptionsSubscriptionFidSetParentSubscriptionParams() *PutCustomersCustomerFidSubscriptionsSubscriptionFidSetParentSubscriptionParams {
	return NewPutCustomersCustomerFidSubscriptionsSubscriptionFidSetParentSubscriptionParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidSubscriptionsSubscriptionFidSetParentSubscriptionParams].
