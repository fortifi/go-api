...
func NewGetCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchParams() *GetCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchParams {
	return NewGetCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchParams].
