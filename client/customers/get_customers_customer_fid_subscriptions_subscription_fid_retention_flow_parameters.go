...
func NewGetCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowParams() *GetCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowParams {
	return NewGetCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowParams].
