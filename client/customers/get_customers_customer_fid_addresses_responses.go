...
func (o *GetCustomersCustomerFidAddressesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidAddressesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /customers/{customerFid}/addresses][%d] GetCustomersCustomerFidAddresses default %s", o._statusCode, payload)
}
...
func (o *GetCustomersCustomerFidAddressesOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidAddressesOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidAddressesOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidAddressesOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidAddressesOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidAddressesOKBodyAO1, errGetCustomersCustomerFidAddressesOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidAddressesOKBodyAO1)
