...
func NewPutCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsPeriodFidRefundParams() *PutCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsPeriodFidRefundParams {
	return NewPutCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsPeriodFidRefundParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsPeriodFidRefundParams].
...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidPeriodsPeriodFidRefundParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AddCreditToInvoice != nil {
		...
		fAddCreditToInvoice := conv.FormatBool(frAddCreditToInvoice)
	...
	if o.RefundAmount != nil {
		...
		fRefundAmount := conv.FormatFloat(frRefundAmount)
		if fRefundAmount != "" {
