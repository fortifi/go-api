...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceOK) Error() string {
	...
	return fmt.Sprintf("[PUT /customers/{customerFid}/subscriptions/{subscriptionFid}/updateRenewalPrice][%d] putCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceOK %s", 200, payload)
}
...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /customers/{customerFid}/subscriptions/{subscriptionFid}/updateRenewalPrice][%d] PutCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPrice default %s", o._statusCode, payload)
}
...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceOKBodyAO1); err != nil {
		return err
	}
...
func (o PutCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceOKBody) MarshalJSON() ([]byte, error) {
	...
	putCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceOKBodyAO1, errPutCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceOKBodyAO1 := jsonutils.WriteJSON(dataPutCustomersCustomerFidSubscriptionsSubscriptionFidUpdateRenewalPriceOKBodyAO1)
