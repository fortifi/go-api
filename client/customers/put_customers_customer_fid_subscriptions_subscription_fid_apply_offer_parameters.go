...
func NewPutCustomersCustomerFidSubscriptionsSubscriptionFidApplyOfferParams() *PutCustomersCustomerFidSubscriptionsSubscriptionFidApplyOfferParams {
	return NewPutCustomersCustomerFidSubscriptionsSubscriptionFidApplyOfferParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidSubscriptionsSubscriptionFidApplyOfferParams].
