...
func (o *GetCustomersCustomerFidChatSessionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidChatSessionsOK) Error() string {
	...
	return fmt.Sprintf("[GET /customers/{customerFid}/chatSessions][%d] getCustomersCustomerFidChatSessionsOK %s", 200, payload)
}
...
func (o *GetCustomersCustomerFidChatSessionsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /customers/{customerFid}/chatSessions][%d] GetCustomersCustomerFidChatSessions default %s", o._statusCode, payload)
}
...
func (o *GetCustomersCustomerFidChatSessionsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidChatSessionsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidChatSessionsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidChatSessionsOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidChatSessionsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidChatSessionsOKBodyAO1, errGetCustomersCustomerFidChatSessionsOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidChatSessionsOKBodyAO1)
