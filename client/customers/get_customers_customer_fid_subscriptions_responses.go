...
func (o *GetCustomersCustomerFidSubscriptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidSubscriptionsOK) Error() string {
	...
	return fmt.Sprintf("[GET /customers/{customerFid}/subscriptions][%d] getCustomersCustomerFidSubscriptionsOK %s", 200, payload)
}
...
func (o *GetCustomersCustomerFidSubscriptionsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /customers/{customerFid}/subscriptions][%d] GetCustomersCustomerFidSubscriptions default %s", o._statusCode, payload)
}
...
func (o *GetCustomersCustomerFidSubscriptionsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidSubscriptionsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidSubscriptionsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidSubscriptionsOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidSubscriptionsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidSubscriptionsOKBodyAO1, errGetCustomersCustomerFidSubscriptionsOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidSubscriptionsOKBodyAO1)
