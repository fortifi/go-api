...
func NewGetCustomersCustomerFidContactsContactFidParams() *GetCustomersCustomerFidContactsContactFidParams {
	return NewGetCustomersCustomerFidContactsContactFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetCustomersCustomerFidContactsContactFidParams].
...
func (o *GetCustomersCustomerFidContactsContactFidParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AllAddresses != nil {
		...
		qAllAddresses := conv.FormatBool(qrAllAddresses)
		if qAllAddresses != "" {
	...
	if o.AllEmails != nil {
		...
		qAllEmails := conv.FormatBool(qrAllEmails)
		if qAllEmails != "" {
	...
	if o.AllPhones != nil {
		...
		qAllPhones := conv.FormatBool(qrAllPhones)
		if qAllPhones != "" {
