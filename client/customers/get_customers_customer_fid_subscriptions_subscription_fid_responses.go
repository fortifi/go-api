...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidOK) Error() string {
	...
	return fmt.Sprintf("[GET /customers/{customerFid}/subscriptions/{subscriptionFid}][%d] getCustomersCustomerFidSubscriptionsSubscriptionFidOK %s", 200, payload)
}
...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /customers/{customerFid}/subscriptions/{subscriptionFid}][%d] GetCustomersCustomerFidSubscriptionsSubscriptionFid default %s", o._statusCode, payload)
}
...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidSubscriptionsSubscriptionFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidSubscriptionsSubscriptionFidOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidSubscriptionsSubscriptionFidOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidSubscriptionsSubscriptionFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidSubscriptionsSubscriptionFidOKBodyAO1, errGetCustomersCustomerFidSubscriptionsSubscriptionFidOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidSubscriptionsSubscriptionFidOKBodyAO1)
