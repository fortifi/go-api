...
func NewPutCustomersCustomerFidSubscriptionsSubscriptionFidAutoSuspendDaysParams() *PutCustomersCustomerFidSubscriptionsSubscriptionFidAutoSuspendDaysParams {
	return NewPutCustomersCustomerFidSubscriptionsSubscriptionFidAutoSuspendDaysParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidSubscriptionsSubscriptionFidAutoSuspendDaysParams].
...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidAutoSuspendDaysParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// form param days
	frDays := o.Days
	fDays := conv.FormatInteger(frDays)
	if fDays != "" {
