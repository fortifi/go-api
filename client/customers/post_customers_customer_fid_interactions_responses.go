...
func (o *PostCustomersCustomerFidInteractionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostCustomersCustomerFidInteractionsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postCustomersCustomerFidInteractionsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostCustomersCustomerFidInteractionsOKBodyAO1); err != nil {
		return err
	}
...
func (o PostCustomersCustomerFidInteractionsOKBody) MarshalJSON() ([]byte, error) {
	...
	postCustomersCustomerFidInteractionsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostCustomersCustomerFidInteractionsOKBodyAO1, errPostCustomersCustomerFidInteractionsOKBodyAO1 := jsonutils.WriteJSON(dataPostCustomersCustomerFidInteractionsOKBodyAO1)
