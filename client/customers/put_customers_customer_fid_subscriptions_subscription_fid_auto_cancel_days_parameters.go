...
func NewPutCustomersCustomerFidSubscriptionsSubscriptionFidAutoCancelDaysParams() *PutCustomersCustomerFidSubscriptionsSubscriptionFidAutoCancelDaysParams {
	return NewPutCustomersCustomerFidSubscriptionsSubscriptionFidAutoCancelDaysParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidSubscriptionsSubscriptionFidAutoCancelDaysParams].
