...
func NewPutCustomersCustomerFidInvoicesInvoiceFidRetryParams() *PutCustomersCustomerFidInvoicesInvoiceFidRetryParams {
	return NewPutCustomersCustomerFidInvoicesInvoiceFidRetryParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidInvoicesInvoiceFidRetryParams].
