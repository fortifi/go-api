...
func (o *PostCustomersCustomerFidPaymentMethodsPaypalInitialiseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostCustomersCustomerFidPaymentMethodsPaypalInitialiseOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postCustomersCustomerFidPaymentMethodsPaypalInitialiseOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostCustomersCustomerFidPaymentMethodsPaypalInitialiseOKBodyAO1); err != nil {
		return err
	}
...
func (o PostCustomersCustomerFidPaymentMethodsPaypalInitialiseOKBody) MarshalJSON() ([]byte, error) {
	...
	postCustomersCustomerFidPaymentMethodsPaypalInitialiseOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostCustomersCustomerFidPaymentMethodsPaypalInitialiseOKBodyAO1, errPostCustomersCustomerFidPaymentMethodsPaypalInitialiseOKBodyAO1 := jsonutils.WriteJSON(dataPostCustomersCustomerFidPaymentMethodsPaypalInitialiseOKBodyAO1)
