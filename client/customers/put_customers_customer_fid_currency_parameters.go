...
func NewPutCustomersCustomerFidCurrencyParams() *PutCustomersCustomerFidCurrencyParams {
	return NewPutCustomersCustomerFidCurrencyParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidCurrencyParams].
