...
func (o *GetCustomersCustomerFidContactsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidContactsOK) Error() string {
	...
	return fmt.Sprintf("[GET /customers/{customerFid}/contacts][%d] getCustomersCustomerFidContactsOK %s", 200, payload)
}
...
func (o *GetCustomersCustomerFidContactsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /customers/{customerFid}/contacts][%d] GetCustomersCustomerFidContacts default %s", o._statusCode, payload)
}
...
func (o *GetCustomersCustomerFidContactsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidContactsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidContactsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidContactsOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidContactsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidContactsOKBodyAO1, errGetCustomersCustomerFidContactsOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidContactsOKBodyAO1)
