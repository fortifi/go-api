...
func (o *GetCustomersCustomerFidTicketsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidTicketsOK) Error() string {
	...
	return fmt.Sprintf("[GET /customers/{customerFid}/tickets][%d] getCustomersCustomerFidTicketsOK %s", 200, payload)
}
...
func (o *GetCustomersCustomerFidTicketsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /customers/{customerFid}/tickets][%d] GetCustomersCustomerFidTickets default %s", o._statusCode, payload)
}
...
func (o *GetCustomersCustomerFidTicketsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidTicketsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidTicketsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidTicketsOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidTicketsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidTicketsOKBodyAO1, errGetCustomersCustomerFidTicketsOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidTicketsOKBodyAO1)
