...
func (o *PutCustomersCustomerFidBillingDataReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutCustomersCustomerFidBillingDataDefault) Error() string {
	...
	return fmt.Sprintf("[PUT /customers/{customerFid}/billingData][%d] PutCustomersCustomerFidBillingData default %s", o._statusCode, payload)
}
