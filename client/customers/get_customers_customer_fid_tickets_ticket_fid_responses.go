...
func (o *GetCustomersCustomerFidTicketsTicketFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidTicketsTicketFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidTicketsTicketFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidTicketsTicketFidOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidTicketsTicketFidOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidTicketsTicketFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidTicketsTicketFidOKBodyAO1, errGetCustomersCustomerFidTicketsTicketFidOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidTicketsTicketFidOKBodyAO1)
