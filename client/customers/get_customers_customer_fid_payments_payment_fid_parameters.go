...
func NewGetCustomersCustomerFidPaymentsPaymentFidParams() *GetCustomersCustomerFidPaymentsPaymentFidParams {
	return NewGetCustomersCustomerFidPaymentsPaymentFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetCustomersCustomerFidPaymentsPaymentFidParams].
