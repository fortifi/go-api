...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOK) Error() string {
	...
	return fmt.Sprintf("[GET /customers/{customerFid}/subscriptions/{subscriptionFid}/cancelFlow/{flowSearch}][%d] getCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOK %s", 200, payload)
}
...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /customers/{customerFid}/subscriptions/{subscriptionFid}/cancelFlow/{flowSearch}][%d] GetCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearch default %s", o._statusCode, payload)
}
...
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOKBodyAO1, errGetCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOKBodyAO1)
