...
func (o *PostCustomersCustomerFidPaymentsPaymentFidChargebackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostCustomersCustomerFidPaymentsPaymentFidChargebackOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postCustomersCustomerFidPaymentsPaymentFidChargebackOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostCustomersCustomerFidPaymentsPaymentFidChargebackOKBodyAO1); err != nil {
		return err
	}
...
func (o PostCustomersCustomerFidPaymentsPaymentFidChargebackOKBody) MarshalJSON() ([]byte, error) {
	...
	postCustomersCustomerFidPaymentsPaymentFidChargebackOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostCustomersCustomerFidPaymentsPaymentFidChargebackOKBodyAO1, errPostCustomersCustomerFidPaymentsPaymentFidChargebackOKBodyAO1 := jsonutils.WriteJSON(dataPostCustomersCustomerFidPaymentsPaymentFidChargebackOKBodyAO1)
