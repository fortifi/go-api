...
func NewPostCustomersCustomerFidPaymentMethodsPaypalInitialiseParams() *PostCustomersCustomerFidPaymentMethodsPaypalInitialiseParams {
	return NewPostCustomersCustomerFidPaymentMethodsPaypalInitialiseParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostCustomersCustomerFidPaymentMethodsPaypalInitialiseParams].
...
func (o *PostCustomersCustomerFidPaymentMethodsPaypalInitialiseParams) bindParamSubscriptionFids(formats strfmt.Registry) []string {
	...
	subscriptionFidsIS := stringutils.JoinByFormat(subscriptionFidsIC, "")
