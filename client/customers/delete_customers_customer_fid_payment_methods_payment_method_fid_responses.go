...
func (o *DeleteCustomersCustomerFidPaymentMethodsPaymentMethodFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
