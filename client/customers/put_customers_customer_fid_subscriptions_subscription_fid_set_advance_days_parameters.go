...
func NewPutCustomersCustomerFidSubscriptionsSubscriptionFidSetAdvanceDaysParams() *PutCustomersCustomerFidSubscriptionsSubscriptionFidSetAdvanceDaysParams {
	return NewPutCustomersCustomerFidSubscriptionsSubscriptionFidSetAdvanceDaysParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidSubscriptionsSubscriptionFidSetAdvanceDaysParams].
