...
func NewGetCustomersCustomerFidTicketsTicketFidPostsParams() *GetCustomersCustomerFidTicketsTicketFidPostsParams {
	return NewGetCustomersCustomerFidTicketsTicketFidPostsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetCustomersCustomerFidTicketsTicketFidPostsParams].
