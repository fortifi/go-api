...
func NewPutCustomersCustomerFidPurchasedParams() *PutCustomersCustomerFidPurchasedParams {
	return NewPutCustomersCustomerFidPurchasedParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidPurchasedParams].
