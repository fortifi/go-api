...
func (o *GetCustomersCustomerFidTicketsTicketFidPostsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCustomersCustomerFidTicketsTicketFidPostsOK) Error() string {
	...
	return fmt.Sprintf("[GET /customers/{customerFid}/tickets/{ticketFid}/posts][%d] getCustomersCustomerFidTicketsTicketFidPostsOK %s", 200, payload)
}
...
func (o *GetCustomersCustomerFidTicketsTicketFidPostsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /customers/{customerFid}/tickets/{ticketFid}/posts][%d] GetCustomersCustomerFidTicketsTicketFidPosts default %s", o._statusCode, payload)
}
...
func (o *GetCustomersCustomerFidTicketsTicketFidPostsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getCustomersCustomerFidTicketsTicketFidPostsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetCustomersCustomerFidTicketsTicketFidPostsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetCustomersCustomerFidTicketsTicketFidPostsOKBody) MarshalJSON() ([]byte, error) {
	...
	getCustomersCustomerFidTicketsTicketFidPostsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetCustomersCustomerFidTicketsTicketFidPostsOKBodyAO1, errGetCustomersCustomerFidTicketsTicketFidPostsOKBodyAO1 := jsonutils.WriteJSON(dataGetCustomersCustomerFidTicketsTicketFidPostsOKBodyAO1)
