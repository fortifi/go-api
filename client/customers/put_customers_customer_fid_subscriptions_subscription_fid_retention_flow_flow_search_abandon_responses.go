...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchAbandonReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchAbandonOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchAbandonOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchAbandonOKBodyAO1); err != nil {
		return err
	}
...
func (o PutCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchAbandonOKBody) MarshalJSON() ([]byte, error) {
	...
	putCustomersCustomerFidSubscriptionsSubscriptionFidRetentionFlowFlowSearchAbandonOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
