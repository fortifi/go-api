...
func NewPutCustomersCustomerFidPaymentMethodsCardsCardFidParams() *PutCustomersCustomerFidPaymentMethodsCardsCardFidParams {
	return NewPutCustomersCustomerFidPaymentMethodsCardsCardFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutCustomersCustomerFidPaymentMethodsCardsCardFidParams].
