...
func (o *GetReservationsKeyApplicationBrandFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetReservationsKeyApplicationBrandFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getReservationsKeyApplicationBrandFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetReservationsKeyApplicationBrandFidOKBodyAO1); err != nil {
		return err
	}
...
func (o GetReservationsKeyApplicationBrandFidOKBody) MarshalJSON() ([]byte, error) {
	...
	getReservationsKeyApplicationBrandFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetReservationsKeyApplicationBrandFidOKBodyAO1, errGetReservationsKeyApplicationBrandFidOKBodyAO1 := jsonutils.WriteJSON(dataGetReservationsKeyApplicationBrandFidOKBodyAO1)
