...
func (o *PostPolymersParentFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostPolymersParentFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postPolymersParentFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostPolymersParentFidOKBodyAO1); err != nil {
		return err
	}
...
func (o PostPolymersParentFidOKBody) MarshalJSON() ([]byte, error) {
	...
	postPolymersParentFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostPolymersParentFidOKBodyAO1, errPostPolymersParentFidOKBodyAO1 := jsonutils.WriteJSON(dataPostPolymersParentFidOKBodyAO1)
