...
func (o *GetPolymersParentFidPolymerFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetPolymersParentFidPolymerFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getPolymersParentFidPolymerFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetPolymersParentFidPolymerFidOKBodyAO1); err != nil {
		return err
	}
...
func (o GetPolymersParentFidPolymerFidOKBody) MarshalJSON() ([]byte, error) {
	...
	getPolymersParentFidPolymerFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetPolymersParentFidPolymerFidOKBodyAO1, errGetPolymersParentFidPolymerFidOKBodyAO1 := jsonutils.WriteJSON(dataGetPolymersParentFidPolymerFidOKBodyAO1)
