...
func NewGetPolymersParentFidPolymerFidParams() *GetPolymersParentFidPolymerFidParams {
	return NewGetPolymersParentFidPolymerFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetPolymersParentFidPolymerFidParams].
...
func (o *GetPolymersParentFidPolymerFidParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// query param allData
	qrAllData := o.AllData
	qAllData := conv.FormatBool(qrAllData)
	if qAllData != "" {
...
func (o *GetPolymersParentFidPolymerFidParams) bindParamDataKeys(formats strfmt.Registry) []string {
	...
	dataKeysIS := stringutils.JoinByFormat(dataKeysIC, "")
