...
func (o *GetMeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetMeOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getMeOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetMeOKBodyAO1); err != nil {
		return err
	}
...
func (o GetMeOKBody) MarshalJSON() ([]byte, error) {
	...
	getMeOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetMeOKBodyAO1, errGetMeOKBodyAO1 := jsonutils.WriteJSON(dataGetMeOKBodyAO1)
