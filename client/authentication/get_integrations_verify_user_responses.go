...
func (o *GetIntegrationsVerifyUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetIntegrationsVerifyUserOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getIntegrationsVerifyUserOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetIntegrationsVerifyUserOKBodyAO1); err != nil {
		return err
	}
...
func (o GetIntegrationsVerifyUserOKBody) MarshalJSON() ([]byte, error) {
	...
	getIntegrationsVerifyUserOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetIntegrationsVerifyUserOKBodyAO1, errGetIntegrationsVerifyUserOKBodyAO1 := jsonutils.WriteJSON(dataGetIntegrationsVerifyUserOKBodyAO1)
