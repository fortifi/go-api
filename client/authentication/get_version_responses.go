...
func (o *GetVersionOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getVersionOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetVersionOKBodyAO1); err != nil {
		return err
	}
...
func (o GetVersionOKBody) MarshalJSON() ([]byte, error) {
	...
	getVersionOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetVersionOKBodyAO1, errGetVersionOKBodyAO1 := jsonutils.WriteJSON(dataGetVersionOKBodyAO1)
