...
func (o *GetOrganisationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetOrganisationOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getOrganisationOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetOrganisationOKBodyAO1); err != nil {
		return err
	}
...
func (o GetOrganisationOKBody) MarshalJSON() ([]byte, error) {
	...
	getOrganisationOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetOrganisationOKBodyAO1, errGetOrganisationOKBodyAO1 := jsonutils.WriteJSON(dataGetOrganisationOKBodyAO1)
