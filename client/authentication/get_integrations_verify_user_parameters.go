...
func NewGetIntegrationsVerifyUserParams() *GetIntegrationsVerifyUserParams {
	return NewGetIntegrationsVerifyUserParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetIntegrationsVerifyUserParams].
