...
func (o *GetServiceAuthTokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetServiceAuthTokenOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getServiceAuthTokenOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetServiceAuthTokenOKBodyAO1); err != nil {
		return err
	}
...
func (o GetServiceAuthTokenOKBody) MarshalJSON() ([]byte, error) {
	...
	getServiceAuthTokenOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetServiceAuthTokenOKBodyAO1, errGetServiceAuthTokenOKBodyAO1 := jsonutils.WriteJSON(dataGetServiceAuthTokenOKBodyAO1)
