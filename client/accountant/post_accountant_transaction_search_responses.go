...
func (o *PostAccountantTransactionSearchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostAccountantTransactionSearchOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postAccountantTransactionSearchOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostAccountantTransactionSearchOKBodyAO1); err != nil {
		return err
	}
...
func (o PostAccountantTransactionSearchOKBody) MarshalJSON() ([]byte, error) {
	...
	postAccountantTransactionSearchOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostAccountantTransactionSearchOKBodyAO1, errPostAccountantTransactionSearchOKBodyAO1 := jsonutils.WriteJSON(dataPostAccountantTransactionSearchOKBodyAO1)
