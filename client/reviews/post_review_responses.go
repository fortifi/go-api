...
func (o *PostReviewReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostReviewOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postReviewOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostReviewOKBodyAO1); err != nil {
		return err
	}
...
func (o PostReviewOKBody) MarshalJSON() ([]byte, error) {
	...
	postReviewOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostReviewOKBodyAO1, errPostReviewOKBodyAO1 := jsonutils.WriteJSON(dataPostReviewOKBodyAO1)
