...
func NewPutEntitiesEntityFidPropertiesValuesPropertyNameParams() *PutEntitiesEntityFidPropertiesValuesPropertyNameParams {
	return NewPutEntitiesEntityFidPropertiesValuesPropertyNameParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutEntitiesEntityFidPropertiesValuesPropertyNameParams].
