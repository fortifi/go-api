...
func (o *GetEntitiesEntityFidLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetEntitiesEntityFidLabelsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getEntitiesEntityFidLabelsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetEntitiesEntityFidLabelsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetEntitiesEntityFidLabelsOKBody) MarshalJSON() ([]byte, error) {
	...
	getEntitiesEntityFidLabelsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetEntitiesEntityFidLabelsOKBodyAO1, errGetEntitiesEntityFidLabelsOKBodyAO1 := jsonutils.WriteJSON(dataGetEntitiesEntityFidLabelsOKBodyAO1)
