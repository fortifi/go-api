...
func NewGetEntitiesEntityFidPropertiesValuesPropertyNameParams() *GetEntitiesEntityFidPropertiesValuesPropertyNameParams {
	return NewGetEntitiesEntityFidPropertiesValuesPropertyNameParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetEntitiesEntityFidPropertiesValuesPropertyNameParams].
