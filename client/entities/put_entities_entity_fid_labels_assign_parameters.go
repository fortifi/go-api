...
func NewPutEntitiesEntityFidLabelsAssignParams() *PutEntitiesEntityFidLabelsAssignParams {
	return NewPutEntitiesEntityFidLabelsAssignParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutEntitiesEntityFidLabelsAssignParams].
