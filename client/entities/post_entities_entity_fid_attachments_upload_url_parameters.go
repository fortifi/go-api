...
func NewPostEntitiesEntityFidAttachmentsUploadURLParams() *PostEntitiesEntityFidAttachmentsUploadURLParams {
	return NewPostEntitiesEntityFidAttachmentsUploadURLParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostEntitiesEntityFidAttachmentsUploadURLParams].
