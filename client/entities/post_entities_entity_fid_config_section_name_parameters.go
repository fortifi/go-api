...
func NewPostEntitiesEntityFidConfigSectionNameParams() *PostEntitiesEntityFidConfigSectionNameParams {
	return NewPostEntitiesEntityFidConfigSectionNameParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostEntitiesEntityFidConfigSectionNameParams].
