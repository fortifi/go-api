...
func (o *PostUploadUploadURLReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostUploadUploadURLOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postUploadUploadURLOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostUploadUploadURLOKBodyAO1); err != nil {
		return err
	}
...
func (o PostUploadUploadURLOKBody) MarshalJSON() ([]byte, error) {
	...
	postUploadUploadURLOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostUploadUploadURLOKBodyAO1, errPostUploadUploadURLOKBodyAO1 := jsonutils.WriteJSON(dataPostUploadUploadURLOKBodyAO1)
