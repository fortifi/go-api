...
func (o *GetEntitiesEntityFidPropertiesFlagsPropertyNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetEntitiesEntityFidPropertiesFlagsPropertyNameOK) Error() string {
	...
	return fmt.Sprintf("[GET /entities/{entityFid}/properties/flags/{propertyName}][%d] getEntitiesEntityFidPropertiesFlagsPropertyNameOK %s", 200, payload)
}
...
func (o *GetEntitiesEntityFidPropertiesFlagsPropertyNameDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /entities/{entityFid}/properties/flags/{propertyName}][%d] GetEntitiesEntityFidPropertiesFlagsPropertyName default %s", o._statusCode, payload)
}
...
func (o *GetEntitiesEntityFidPropertiesFlagsPropertyNameOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getEntitiesEntityFidPropertiesFlagsPropertyNameOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetEntitiesEntityFidPropertiesFlagsPropertyNameOKBodyAO1); err != nil {
		return err
	}
...
func (o GetEntitiesEntityFidPropertiesFlagsPropertyNameOKBody) MarshalJSON() ([]byte, error) {
	...
	getEntitiesEntityFidPropertiesFlagsPropertyNameOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetEntitiesEntityFidPropertiesFlagsPropertyNameOKBodyAO1, errGetEntitiesEntityFidPropertiesFlagsPropertyNameOKBodyAO1 := jsonutils.WriteJSON(dataGetEntitiesEntityFidPropertiesFlagsPropertyNameOKBodyAO1)
