...
func (o *PostEntitiesEntityFidAttachmentsUploadURLOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postEntitiesEntityFidAttachmentsUploadURLOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostEntitiesEntityFidAttachmentsUploadURLOKBodyAO1); err != nil {
		return err
	}
...
func (o PostEntitiesEntityFidAttachmentsUploadURLOKBody) MarshalJSON() ([]byte, error) {
	...
	postEntitiesEntityFidAttachmentsUploadURLOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostEntitiesEntityFidAttachmentsUploadURLOKBodyAO1, errPostEntitiesEntityFidAttachmentsUploadURLOKBodyAO1 := jsonutils.WriteJSON(dataPostEntitiesEntityFidAttachmentsUploadURLOKBodyAO1)
