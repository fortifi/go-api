...
func (o *GetEntitiesEntityFidConfigSectionNameItemsItemNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetEntitiesEntityFidConfigSectionNameItemsItemNameOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getEntitiesEntityFidConfigSectionNameItemsItemNameOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetEntitiesEntityFidConfigSectionNameItemsItemNameOKBodyAO1); err != nil {
		return err
	}
...
func (o GetEntitiesEntityFidConfigSectionNameItemsItemNameOKBody) MarshalJSON() ([]byte, error) {
	...
	getEntitiesEntityFidConfigSectionNameItemsItemNameOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetEntitiesEntityFidConfigSectionNameItemsItemNameOKBodyAO1, errGetEntitiesEntityFidConfigSectionNameItemsItemNameOKBodyAO1 := jsonutils.WriteJSON(dataGetEntitiesEntityFidConfigSectionNameItemsItemNameOKBodyAO1)
