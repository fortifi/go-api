...
func NewPutEntitiesEntityFidPropertiesCountersPropertyNameDecrementParams() *PutEntitiesEntityFidPropertiesCountersPropertyNameDecrementParams {
	return NewPutEntitiesEntityFidPropertiesCountersPropertyNameDecrementParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutEntitiesEntityFidPropertiesCountersPropertyNameDecrementParams].
