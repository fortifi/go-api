...
func (o *GetEntitiesEntityFidConfigSectionNameOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getEntitiesEntityFidConfigSectionNameOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetEntitiesEntityFidConfigSectionNameOKBodyAO1); err != nil {
		return err
	}
...
func (o GetEntitiesEntityFidConfigSectionNameOKBody) MarshalJSON() ([]byte, error) {
	...
	getEntitiesEntityFidConfigSectionNameOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetEntitiesEntityFidConfigSectionNameOKBodyAO1, errGetEntitiesEntityFidConfigSectionNameOKBodyAO1 := jsonutils.WriteJSON(dataGetEntitiesEntityFidConfigSectionNameOKBodyAO1)
