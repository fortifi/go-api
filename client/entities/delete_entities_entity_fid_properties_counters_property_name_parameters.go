...
func NewDeleteEntitiesEntityFidPropertiesCountersPropertyNameParams() *DeleteEntitiesEntityFidPropertiesCountersPropertyNameParams {
	return NewDeleteEntitiesEntityFidPropertiesCountersPropertyNameParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteEntitiesEntityFidPropertiesCountersPropertyNameParams].
