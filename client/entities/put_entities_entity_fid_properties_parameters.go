...
func NewPutEntitiesEntityFidPropertiesParams() *PutEntitiesEntityFidPropertiesParams {
	return NewPutEntitiesEntityFidPropertiesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutEntitiesEntityFidPropertiesParams].
