...
func (o *GetEntitiesEntityFidPropertiesValuesPropertyNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetEntitiesEntityFidPropertiesValuesPropertyNameOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getEntitiesEntityFidPropertiesValuesPropertyNameOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetEntitiesEntityFidPropertiesValuesPropertyNameOKBodyAO1); err != nil {
		return err
	}
...
func (o GetEntitiesEntityFidPropertiesValuesPropertyNameOKBody) MarshalJSON() ([]byte, error) {
	...
	getEntitiesEntityFidPropertiesValuesPropertyNameOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetEntitiesEntityFidPropertiesValuesPropertyNameOKBodyAO1, errGetEntitiesEntityFidPropertiesValuesPropertyNameOKBodyAO1 := jsonutils.WriteJSON(dataGetEntitiesEntityFidPropertiesValuesPropertyNameOKBodyAO1)
