...
func NewGetEntitiesEntityFidConfigSectionNameItemsItemNameParams() *GetEntitiesEntityFidConfigSectionNameItemsItemNameParams {
	return NewGetEntitiesEntityFidConfigSectionNameItemsItemNameParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetEntitiesEntityFidConfigSectionNameItemsItemNameParams].
