...
func (o *GetEntitiesEntityFidPropertiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetEntitiesEntityFidPropertiesOK) Error() string {
	...
	return fmt.Sprintf("[GET /entities/{entityFid}/properties][%d] getEntitiesEntityFidPropertiesOK %s", 200, payload)
}
...
func (o *GetEntitiesEntityFidPropertiesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /entities/{entityFid}/properties][%d] GetEntitiesEntityFidProperties default %s", o._statusCode, payload)
}
...
func (o *GetEntitiesEntityFidPropertiesOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getEntitiesEntityFidPropertiesOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetEntitiesEntityFidPropertiesOKBodyAO1); err != nil {
		return err
	}
...
func (o GetEntitiesEntityFidPropertiesOKBody) MarshalJSON() ([]byte, error) {
	...
	getEntitiesEntityFidPropertiesOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetEntitiesEntityFidPropertiesOKBodyAO1, errGetEntitiesEntityFidPropertiesOKBodyAO1 := jsonutils.WriteJSON(dataGetEntitiesEntityFidPropertiesOKBodyAO1)
