...
func (o *GetFinancePaymentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetFinancePaymentsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getFinancePaymentsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetFinancePaymentsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetFinancePaymentsOKBody) MarshalJSON() ([]byte, error) {
	...
	getFinancePaymentsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetFinancePaymentsOKBodyAO1, errGetFinancePaymentsOKBodyAO1 := jsonutils.WriteJSON(dataGetFinancePaymentsOKBodyAO1)
