...
func (o *GetPublishersPublisherFidFinanceCostImportCostImportFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetPublishersPublisherFidFinanceCostImportCostImportFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getPublishersPublisherFidFinanceCostImportCostImportFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetPublishersPublisherFidFinanceCostImportCostImportFidOKBodyAO1); err != nil {
		return err
	}
...
func (o GetPublishersPublisherFidFinanceCostImportCostImportFidOKBody) MarshalJSON() ([]byte, error) {
	...
	getPublishersPublisherFidFinanceCostImportCostImportFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetPublishersPublisherFidFinanceCostImportCostImportFidOKBodyAO1, errGetPublishersPublisherFidFinanceCostImportCostImportFidOKBodyAO1 := jsonutils.WriteJSON(dataGetPublishersPublisherFidFinanceCostImportCostImportFidOKBodyAO1)
