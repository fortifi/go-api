...
func NewGetFinancePaymentsParams() *GetFinancePaymentsParams {
	return NewGetFinancePaymentsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetFinancePaymentsParams].
...
func (o *GetFinancePaymentsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Amount != nil {
		...
		qAmount := conv.FormatFloat(qrAmount)
		if qAmount != "" {
	...
	if o.DateTolerance != nil {
		...
		qDateTolerance := conv.FormatFloat(qrDateTolerance)
		if qDateTolerance != "" {
