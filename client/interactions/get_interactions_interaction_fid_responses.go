...
func (o *GetInteractionsInteractionFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetInteractionsInteractionFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getInteractionsInteractionFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetInteractionsInteractionFidOKBodyAO1); err != nil {
		return err
	}
...
func (o GetInteractionsInteractionFidOKBody) MarshalJSON() ([]byte, error) {
	...
	getInteractionsInteractionFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetInteractionsInteractionFidOKBodyAO1, errGetInteractionsInteractionFidOKBodyAO1 := jsonutils.WriteJSON(dataGetInteractionsInteractionFidOKBodyAO1)
