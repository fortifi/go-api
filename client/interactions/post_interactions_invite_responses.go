...
func (o *PostInteractionsInviteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostInteractionsInviteOK) Error() string {
	...
	return fmt.Sprintf("[POST /interactions/invite][%d] postInteractionsInviteOK %s", 200, payload)
}
...
func (o *PostInteractionsInviteDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /interactions/invite][%d] PostInteractionsInvite default %s", o._statusCode, payload)
}
...
func (o *PostInteractionsInviteOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postInteractionsInviteOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostInteractionsInviteOKBodyAO1); err != nil {
		return err
	}
...
func (o PostInteractionsInviteOKBody) MarshalJSON() ([]byte, error) {
	...
	postInteractionsInviteOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostInteractionsInviteOKBodyAO1, errPostInteractionsInviteOKBodyAO1 := jsonutils.WriteJSON(dataPostInteractionsInviteOKBodyAO1)
