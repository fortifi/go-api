...
func NewPostInteractionsInteractionFidCustomerClosedParams() *PostInteractionsInteractionFidCustomerClosedParams {
	return NewPostInteractionsInteractionFidCustomerClosedParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostInteractionsInteractionFidCustomerClosedParams].
