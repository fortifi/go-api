...
func (o *PostInteractionsJourneyOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postInteractionsJourneyOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostInteractionsJourneyOKBodyAO1); err != nil {
		return err
	}
...
func (o PostInteractionsJourneyOKBody) MarshalJSON() ([]byte, error) {
	...
	postInteractionsJourneyOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostInteractionsJourneyOKBodyAO1, errPostInteractionsJourneyOKBodyAO1 := jsonutils.WriteJSON(dataPostInteractionsJourneyOKBodyAO1)
