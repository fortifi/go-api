...
func (o *PostInteractionsInviteInviteCodeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostInteractionsInviteInviteCodeOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postInteractionsInviteInviteCodeOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostInteractionsInviteInviteCodeOKBodyAO1); err != nil {
		return err
	}
...
func (o PostInteractionsInviteInviteCodeOKBody) MarshalJSON() ([]byte, error) {
	...
	postInteractionsInviteInviteCodeOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostInteractionsInviteInviteCodeOKBodyAO1, errPostInteractionsInviteInviteCodeOKBodyAO1 := jsonutils.WriteJSON(dataPostInteractionsInviteInviteCodeOKBodyAO1)
