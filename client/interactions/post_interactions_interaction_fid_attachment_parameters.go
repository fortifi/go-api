...
func NewPostInteractionsInteractionFidAttachmentParams() *PostInteractionsInteractionFidAttachmentParams {
	return NewPostInteractionsInteractionFidAttachmentParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostInteractionsInteractionFidAttachmentParams].
