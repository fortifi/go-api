...
func (o *PostInteractionsInteractionFidFeedbackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostInteractionsInteractionFidFeedbackOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postInteractionsInteractionFidFeedbackOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostInteractionsInteractionFidFeedbackOKBodyAO1); err != nil {
		return err
	}
...
func (o PostInteractionsInteractionFidFeedbackOKBody) MarshalJSON() ([]byte, error) {
	...
	postInteractionsInteractionFidFeedbackOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostInteractionsInteractionFidFeedbackOKBodyAO1, errPostInteractionsInteractionFidFeedbackOKBodyAO1 := jsonutils.WriteJSON(dataPostInteractionsInteractionFidFeedbackOKBodyAO1)
