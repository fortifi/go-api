...
func (o *PostInteractionsInteractionFidCustomerClosedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostInteractionsInteractionFidCustomerClosedOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postInteractionsInteractionFidCustomerClosedOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostInteractionsInteractionFidCustomerClosedOKBodyAO1); err != nil {
		return err
	}
...
func (o PostInteractionsInteractionFidCustomerClosedOKBody) MarshalJSON() ([]byte, error) {
	...
	postInteractionsInteractionFidCustomerClosedOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostInteractionsInteractionFidCustomerClosedOKBodyAO1, errPostInteractionsInteractionFidCustomerClosedOKBodyAO1 := jsonutils.WriteJSON(dataPostInteractionsInteractionFidCustomerClosedOKBodyAO1)
