...
func NewGetInteractionsInteractionFidParams() *GetInteractionsInteractionFidParams {
	return NewGetInteractionsInteractionFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetInteractionsInteractionFidParams].
