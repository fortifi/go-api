...
func NewPutTicketsTicketFidStatusParams() *PutTicketsTicketFidStatusParams {
	return NewPutTicketsTicketFidStatusParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutTicketsTicketFidStatusParams].
