...
func (o *PostTicketsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /tickets][%d] PostTickets default %s", o._statusCode, payload)
}
...
func (o *PostTicketsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postTicketsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostTicketsOKBodyAO1); err != nil {
		return err
	}
...
func (o PostTicketsOKBody) MarshalJSON() ([]byte, error) {
	...
	postTicketsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostTicketsOKBodyAO1, errPostTicketsOKBodyAO1 := jsonutils.WriteJSON(dataPostTicketsOKBodyAO1)
