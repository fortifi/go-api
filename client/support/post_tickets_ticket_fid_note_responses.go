...
func (o *PostTicketsTicketFidNoteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostTicketsTicketFidNoteOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postTicketsTicketFidNoteOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostTicketsTicketFidNoteOKBodyAO1); err != nil {
		return err
	}
...
func (o PostTicketsTicketFidNoteOKBody) MarshalJSON() ([]byte, error) {
	...
	postTicketsTicketFidNoteOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostTicketsTicketFidNoteOKBodyAO1, errPostTicketsTicketFidNoteOKBodyAO1 := jsonutils.WriteJSON(dataPostTicketsTicketFidNoteOKBodyAO1)
