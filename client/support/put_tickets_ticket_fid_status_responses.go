...
func (o *PutTicketsTicketFidStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutTicketsTicketFidStatusOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putTicketsTicketFidStatusOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutTicketsTicketFidStatusOKBodyAO1); err != nil {
		return err
	}
...
func (o PutTicketsTicketFidStatusOKBody) MarshalJSON() ([]byte, error) {
	...
	putTicketsTicketFidStatusOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutTicketsTicketFidStatusOKBodyAO1, errPutTicketsTicketFidStatusOKBodyAO1 := jsonutils.WriteJSON(dataPutTicketsTicketFidStatusOKBodyAO1)
