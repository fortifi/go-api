...
func (o *PostProductsProductFidAvailabilityReserveReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostProductsProductFidAvailabilityReserveOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postProductsProductFidAvailabilityReserveOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostProductsProductFidAvailabilityReserveOKBodyAO1); err != nil {
		return err
	}
...
func (o PostProductsProductFidAvailabilityReserveOKBody) MarshalJSON() ([]byte, error) {
	...
	postProductsProductFidAvailabilityReserveOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostProductsProductFidAvailabilityReserveOKBodyAO1, errPostProductsProductFidAvailabilityReserveOKBodyAO1 := jsonutils.WriteJSON(dataPostProductsProductFidAvailabilityReserveOKBodyAO1)
