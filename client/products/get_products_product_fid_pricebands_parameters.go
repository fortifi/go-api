...
func NewGetProductsProductFidPricebandsParams() *GetProductsProductFidPricebandsParams {
	return NewGetProductsProductFidPricebandsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetProductsProductFidPricebandsParams].
