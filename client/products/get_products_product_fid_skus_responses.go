...
func (o *GetProductsProductFidSkusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetProductsProductFidSkusOK) Error() string {
	...
	return fmt.Sprintf("[GET /products/{productFid}/skus][%d] getProductsProductFidSkusOK %s", 200, payload)
}
...
func (o *GetProductsProductFidSkusDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /products/{productFid}/skus][%d] GetProductsProductFidSkus default %s", o._statusCode, payload)
}
...
func (o *GetProductsProductFidSkusOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getProductsProductFidSkusOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetProductsProductFidSkusOKBodyAO1); err != nil {
		return err
	}
...
func (o GetProductsProductFidSkusOKBody) MarshalJSON() ([]byte, error) {
	...
	getProductsProductFidSkusOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetProductsProductFidSkusOKBodyAO1, errGetProductsProductFidSkusOKBodyAO1 := jsonutils.WriteJSON(dataGetProductsProductFidSkusOKBodyAO1)
