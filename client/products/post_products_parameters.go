...
// WithPayload adds the payload to the post products params
func (o *PostProductsParams) WithPayload(payload *models.CreateProductPayload) *PostProductsParams {
	o.SetPayload(payload)
	return o
}

// SetPayload adds the payload to the post products params
func (o *PostProductsParams) SetPayload(payload *models.CreateProductPayload) {
	o.Payload = payload
}
