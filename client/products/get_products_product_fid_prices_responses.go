...
func (o *GetProductsProductFidPricesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetProductsProductFidPricesOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getProductsProductFidPricesOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetProductsProductFidPricesOKBodyAO1); err != nil {
		return err
	}
...
func (o GetProductsProductFidPricesOKBody) MarshalJSON() ([]byte, error) {
	...
	getProductsProductFidPricesOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetProductsProductFidPricesOKBodyAO1, errGetProductsProductFidPricesOKBodyAO1 := jsonutils.WriteJSON(dataGetProductsProductFidPricesOKBodyAO1)
