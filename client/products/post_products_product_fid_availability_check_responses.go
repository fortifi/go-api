...
func (o *PostProductsProductFidAvailabilityCheckReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostProductsProductFidAvailabilityCheckOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postProductsProductFidAvailabilityCheckOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostProductsProductFidAvailabilityCheckOKBodyAO1); err != nil {
		return err
	}
...
func (o PostProductsProductFidAvailabilityCheckOKBody) MarshalJSON() ([]byte, error) {
	...
	postProductsProductFidAvailabilityCheckOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostProductsProductFidAvailabilityCheckOKBodyAO1, errPostProductsProductFidAvailabilityCheckOKBodyAO1 := jsonutils.WriteJSON(dataPostProductsProductFidAvailabilityCheckOKBodyAO1)
