...
func (o *GetProductsProductFidPricebandsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetProductsProductFidPricebandsOK) Error() string {
	...
	return fmt.Sprintf("[GET /products/{productFid}/pricebands][%d] getProductsProductFidPricebandsOK %s", 200, payload)
}
...
func (o *GetProductsProductFidPricebandsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /products/{productFid}/pricebands][%d] GetProductsProductFidPricebands default %s", o._statusCode, payload)
}
...
func (o *GetProductsProductFidPricebandsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getProductsProductFidPricebandsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetProductsProductFidPricebandsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetProductsProductFidPricebandsOKBody) MarshalJSON() ([]byte, error) {
	...
	getProductsProductFidPricebandsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetProductsProductFidPricebandsOKBodyAO1, errGetProductsProductFidPricebandsOKBodyAO1 := jsonutils.WriteJSON(dataGetProductsProductFidPricebandsOKBodyAO1)
