...
func NewPutContactsEmailsEmailAddressConfirmParams() *PutContactsEmailsEmailAddressConfirmParams {
	return NewPutContactsEmailsEmailAddressConfirmParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutContactsEmailsEmailAddressConfirmParams].
