...
func NewPutContactsEmailsEmailAddressUnsubscribeParams() *PutContactsEmailsEmailAddressUnsubscribeParams {
	return NewPutContactsEmailsEmailAddressUnsubscribeParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutContactsEmailsEmailAddressUnsubscribeParams].
