...
func NewPutMessengerDeliveriesDeliveryFidSubscribeParams() *PutMessengerDeliveriesDeliveryFidSubscribeParams {
	return NewPutMessengerDeliveriesDeliveryFidSubscribeParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutMessengerDeliveriesDeliveryFidSubscribeParams].
...
func (o *PutMessengerDeliveriesDeliveryFidSubscribeParams) bindParamOptInData(formats strfmt.Registry) []string {
	...
	optInDataIS := stringutils.JoinByFormat(optInDataIC, "")
