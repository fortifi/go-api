...
func (o *GetContactsFindByReferenceContactReferenceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetContactsFindByReferenceContactReferenceOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getContactsFindByReferenceContactReferenceOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetContactsFindByReferenceContactReferenceOKBodyAO1); err != nil {
		return err
	}
...
func (o GetContactsFindByReferenceContactReferenceOKBody) MarshalJSON() ([]byte, error) {
	...
	getContactsFindByReferenceContactReferenceOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetContactsFindByReferenceContactReferenceOKBodyAO1, errGetContactsFindByReferenceContactReferenceOKBodyAO1 := jsonutils.WriteJSON(dataGetContactsFindByReferenceContactReferenceOKBodyAO1)
