...
func NewPutContactsDeviceHardwareIDSubscribeParams() *PutContactsDeviceHardwareIDSubscribeParams {
	return NewPutContactsDeviceHardwareIDSubscribeParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutContactsDeviceHardwareIDSubscribeParams].
