...
func NewPostAccountVerificationParams() *PostAccountVerificationParams {
	return NewPostAccountVerificationParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostAccountVerificationParams].
