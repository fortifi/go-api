...
func (o *PostAppstoreCustomerFidGoogleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostAppstoreCustomerFidGoogleOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postAppstoreCustomerFidGoogleOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostAppstoreCustomerFidGoogleOKBodyAO1); err != nil {
		return err
	}
...
func (o PostAppstoreCustomerFidGoogleOKBody) MarshalJSON() ([]byte, error) {
	...
	postAppstoreCustomerFidGoogleOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostAppstoreCustomerFidGoogleOKBodyAO1, errPostAppstoreCustomerFidGoogleOKBodyAO1 := jsonutils.WriteJSON(dataPostAppstoreCustomerFidGoogleOKBodyAO1)
