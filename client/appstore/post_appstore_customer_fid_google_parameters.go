...
func NewPostAppstoreCustomerFidGoogleParams() *PostAppstoreCustomerFidGoogleParams {
	return NewPostAppstoreCustomerFidGoogleParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostAppstoreCustomerFidGoogleParams].
