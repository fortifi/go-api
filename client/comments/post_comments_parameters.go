...
func NewPostCommentsParams() *PostCommentsParams {
	return NewPostCommentsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostCommentsParams].
