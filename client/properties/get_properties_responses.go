...
func (o *GetPropertiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetPropertiesOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getPropertiesOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetPropertiesOKBodyAO1); err != nil {
		return err
	}
...
func (o GetPropertiesOKBody) MarshalJSON() ([]byte, error) {
	...
	getPropertiesOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetPropertiesOKBodyAO1, errGetPropertiesOKBodyAO1 := jsonutils.WriteJSON(dataGetPropertiesOKBodyAO1)
