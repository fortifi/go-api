...
func (o *PutOrdersOrderFidVerifyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutOrdersOrderFidVerifyOK) Error() string {
	...
	return fmt.Sprintf("[PUT /orders/{orderFid}/verify][%d] putOrdersOrderFidVerifyOK %s", 200, payload)
}
...
func (o *PutOrdersOrderFidVerifyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /orders/{orderFid}/verify][%d] PutOrdersOrderFidVerify default %s", o._statusCode, payload)
}
...
func (o *PutOrdersOrderFidVerifyOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putOrdersOrderFidVerifyOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutOrdersOrderFidVerifyOKBodyAO1); err != nil {
		return err
	}
...
func (o PutOrdersOrderFidVerifyOKBody) MarshalJSON() ([]byte, error) {
	...
	putOrdersOrderFidVerifyOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutOrdersOrderFidVerifyOKBodyAO1, errPutOrdersOrderFidVerifyOKBodyAO1 := jsonutils.WriteJSON(dataPutOrdersOrderFidVerifyOKBodyAO1)
