...
func NewPostOrdersOrderFidOffersParams() *PostOrdersOrderFidOffersParams {
	return NewPostOrdersOrderFidOffersParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostOrdersOrderFidOffersParams].
...
func (o *PostOrdersOrderFidOffersParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Replace != nil {
		...
		fReplace := conv.FormatBool(frReplace)
		if fReplace != "" {
