...
func (o *PutOrdersOrderFidCancelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutOrdersOrderFidCancelOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putOrdersOrderFidCancelOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutOrdersOrderFidCancelOKBodyAO1); err != nil {
		return err
	}
...
func (o PutOrdersOrderFidCancelOKBody) MarshalJSON() ([]byte, error) {
	...
	putOrdersOrderFidCancelOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutOrdersOrderFidCancelOKBodyAO1, errPutOrdersOrderFidCancelOKBodyAO1 := jsonutils.WriteJSON(dataPutOrdersOrderFidCancelOKBodyAO1)
