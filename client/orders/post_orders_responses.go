...
func (o *PostOrdersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostOrdersOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postOrdersOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostOrdersOKBodyAO1); err != nil {
		return err
	}
...
func (o PostOrdersOKBody) MarshalJSON() ([]byte, error) {
	...
	postOrdersOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostOrdersOKBodyAO1, errPostOrdersOKBodyAO1 := jsonutils.WriteJSON(dataPostOrdersOKBodyAO1)
