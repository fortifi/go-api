...
func (o *PutOrdersOrderFidProductsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutOrdersOrderFidProductsOK) Error() string {
	...
	return fmt.Sprintf("[PUT /orders/{orderFid}/products][%d] putOrdersOrderFidProductsOK %s", 200, payload)
}
...
func (o *PutOrdersOrderFidProductsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /orders/{orderFid}/products][%d] PutOrdersOrderFidProducts default %s", o._statusCode, payload)
}
...
func (o *PutOrdersOrderFidProductsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putOrdersOrderFidProductsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutOrdersOrderFidProductsOKBodyAO1); err != nil {
		return err
	}
...
func (o PutOrdersOrderFidProductsOKBody) MarshalJSON() ([]byte, error) {
	...
	putOrdersOrderFidProductsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutOrdersOrderFidProductsOKBodyAO1, errPutOrdersOrderFidProductsOKBodyAO1 := jsonutils.WriteJSON(dataPutOrdersOrderFidProductsOKBodyAO1)
