...
func (o *PutOrdersOrderFidItemsProductFidOrderItemFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutOrdersOrderFidItemsProductFidOrderItemFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putOrdersOrderFidItemsProductFidOrderItemFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutOrdersOrderFidItemsProductFidOrderItemFidOKBodyAO1); err != nil {
		return err
	}
...
func (o PutOrdersOrderFidItemsProductFidOrderItemFidOKBody) MarshalJSON() ([]byte, error) {
	...
	putOrdersOrderFidItemsProductFidOrderItemFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutOrdersOrderFidItemsProductFidOrderItemFidOKBodyAO1, errPutOrdersOrderFidItemsProductFidOrderItemFidOKBodyAO1 := jsonutils.WriteJSON(dataPutOrdersOrderFidItemsProductFidOrderItemFidOKBodyAO1)
