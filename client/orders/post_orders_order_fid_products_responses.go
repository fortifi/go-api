...
func (o *PostOrdersOrderFidProductsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostOrdersOrderFidProductsOK) Error() string {
	...
	return fmt.Sprintf("[POST /orders/{orderFid}/products][%d] postOrdersOrderFidProductsOK %s", 200, payload)
}
...
func (o *PostOrdersOrderFidProductsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /orders/{orderFid}/products][%d] PostOrdersOrderFidProducts default %s", o._statusCode, payload)
}
...
func (o *PostOrdersOrderFidProductsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postOrdersOrderFidProductsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostOrdersOrderFidProductsOKBodyAO1); err != nil {
		return err
	}
...
func (o PostOrdersOrderFidProductsOKBody) MarshalJSON() ([]byte, error) {
	...
	postOrdersOrderFidProductsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostOrdersOrderFidProductsOKBodyAO1, errPostOrdersOrderFidProductsOKBodyAO1 := jsonutils.WriteJSON(dataPostOrdersOrderFidProductsOKBodyAO1)
