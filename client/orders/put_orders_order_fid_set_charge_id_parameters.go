...
func NewPutOrdersOrderFidSetChargeIDParams() *PutOrdersOrderFidSetChargeIDParams {
	return NewPutOrdersOrderFidSetChargeIDParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutOrdersOrderFidSetChargeIDParams].
