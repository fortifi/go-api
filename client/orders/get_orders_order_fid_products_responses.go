...
func (o *GetOrdersOrderFidProductsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetOrdersOrderFidProductsOK) Error() string {
	...
	return fmt.Sprintf("[GET /orders/{orderFid}/products][%d] getOrdersOrderFidProductsOK %s", 200, payload)
}
...
func (o *GetOrdersOrderFidProductsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orders/{orderFid}/products][%d] GetOrdersOrderFidProducts default %s", o._statusCode, payload)
}
...
func (o *GetOrdersOrderFidProductsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getOrdersOrderFidProductsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetOrdersOrderFidProductsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetOrdersOrderFidProductsOKBody) MarshalJSON() ([]byte, error) {
	...
	getOrdersOrderFidProductsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetOrdersOrderFidProductsOKBodyAO1, errGetOrdersOrderFidProductsOKBodyAO1 := jsonutils.WriteJSON(dataGetOrdersOrderFidProductsOKBodyAO1)
