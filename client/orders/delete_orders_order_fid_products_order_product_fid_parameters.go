...
func NewDeleteOrdersOrderFidProductsOrderProductFidParams() *DeleteOrdersOrderFidProductsOrderProductFidParams {
	return NewDeleteOrdersOrderFidProductsOrderProductFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteOrdersOrderFidProductsOrderProductFidParams].
