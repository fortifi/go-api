...
func NewPutOrdersOrderFidExternalReferenceParams() *PutOrdersOrderFidExternalReferenceParams {
	return NewPutOrdersOrderFidExternalReferenceParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutOrdersOrderFidExternalReferenceParams].
