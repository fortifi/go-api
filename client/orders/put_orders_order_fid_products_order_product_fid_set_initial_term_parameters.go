...
func NewPutOrdersOrderFidProductsOrderProductFidSetInitialTermParams() *PutOrdersOrderFidProductsOrderProductFidSetInitialTermParams {
	return NewPutOrdersOrderFidProductsOrderProductFidSetInitialTermParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutOrdersOrderFidProductsOrderProductFidSetInitialTermParams].
