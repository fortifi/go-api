...
func NewPutOrdersOrderFidCancelParams() *PutOrdersOrderFidCancelParams {
	return NewPutOrdersOrderFidCancelParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutOrdersOrderFidCancelParams].
