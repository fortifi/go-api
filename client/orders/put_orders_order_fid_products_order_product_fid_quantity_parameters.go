...
func NewPutOrdersOrderFidProductsOrderProductFidQuantityParams() *PutOrdersOrderFidProductsOrderProductFidQuantityParams {
	return NewPutOrdersOrderFidProductsOrderProductFidQuantityParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutOrdersOrderFidProductsOrderProductFidQuantityParams].
...
func (o *PutOrdersOrderFidProductsOrderProductFidQuantityParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	fQuantity := conv.FormatInteger(frQuantity)
	if fQuantity != "" {
