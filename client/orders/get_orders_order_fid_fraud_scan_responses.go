...
func (o *GetOrdersOrderFidFraudScanReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetOrdersOrderFidFraudScanOK) Error() string {
	...
	return fmt.Sprintf("[GET /orders/{orderFid}/fraudScan][%d] getOrdersOrderFidFraudScanOK %s", 200, payload)
}
...
func (o *GetOrdersOrderFidFraudScanDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /orders/{orderFid}/fraudScan][%d] GetOrdersOrderFidFraudScan default %s", o._statusCode, payload)
}
...
func (o *GetOrdersOrderFidFraudScanOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getOrdersOrderFidFraudScanOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetOrdersOrderFidFraudScanOKBodyAO1); err != nil {
		return err
	}
...
func (o GetOrdersOrderFidFraudScanOKBody) MarshalJSON() ([]byte, error) {
	...
	getOrdersOrderFidFraudScanOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetOrdersOrderFidFraudScanOKBodyAO1, errGetOrdersOrderFidFraudScanOKBodyAO1 := jsonutils.WriteJSON(dataGetOrdersOrderFidFraudScanOKBodyAO1)
