...
func (o *PutOrdersOrderFidConfirmPayPalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutOrdersOrderFidConfirmPayPalOK) Error() string {
	...
	return fmt.Sprintf("[PUT /orders/{orderFid}/confirmPayPal][%d] putOrdersOrderFidConfirmPayPalOK %s", 200, payload)
}
...
func (o *PutOrdersOrderFidConfirmPayPalDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /orders/{orderFid}/confirmPayPal][%d] PutOrdersOrderFidConfirmPayPal default %s", o._statusCode, payload)
}
...
func (o *PutOrdersOrderFidConfirmPayPalOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putOrdersOrderFidConfirmPayPalOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutOrdersOrderFidConfirmPayPalOKBodyAO1); err != nil {
		return err
	}
...
func (o PutOrdersOrderFidConfirmPayPalOKBody) MarshalJSON() ([]byte, error) {
	...
	putOrdersOrderFidConfirmPayPalOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutOrdersOrderFidConfirmPayPalOKBodyAO1, errPutOrdersOrderFidConfirmPayPalOKBodyAO1 := jsonutils.WriteJSON(dataPutOrdersOrderFidConfirmPayPalOKBodyAO1)
