...
func NewPutOrdersOrderFidFinalizeParams() *PutOrdersOrderFidFinalizeParams {
	return NewPutOrdersOrderFidFinalizeParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutOrdersOrderFidFinalizeParams].
