...
func NewPostOrdersOrderFidProductsParams() *PostOrdersOrderFidProductsParams {
	return NewPostOrdersOrderFidProductsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostOrdersOrderFidProductsParams].
