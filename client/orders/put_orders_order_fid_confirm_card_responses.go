...
func (o *PutOrdersOrderFidConfirmCardReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutOrdersOrderFidConfirmCardOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &putOrdersOrderFidConfirmCardOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPutOrdersOrderFidConfirmCardOKBodyAO1); err != nil {
		return err
	}
...
func (o PutOrdersOrderFidConfirmCardOKBody) MarshalJSON() ([]byte, error) {
	...
	putOrdersOrderFidConfirmCardOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPutOrdersOrderFidConfirmCardOKBodyAO1, errPutOrdersOrderFidConfirmCardOKBodyAO1 := jsonutils.WriteJSON(dataPutOrdersOrderFidConfirmCardOKBodyAO1)
