...
func NewGetPublishersPublisherFidParams() *GetPublishersPublisherFidParams {
	return NewGetPublishersPublisherFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetPublishersPublisherFidParams].
