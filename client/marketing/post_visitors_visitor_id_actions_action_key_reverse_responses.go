...
func (o *PostVisitorsVisitorIDActionsActionKeyReverseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostVisitorsVisitorIDActionsActionKeyReverseOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postVisitorsVisitorIDActionsActionKeyReverseOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostVisitorsVisitorIDActionsActionKeyReverseOKBodyAO1); err != nil {
		return err
	}
...
func (o PostVisitorsVisitorIDActionsActionKeyReverseOKBody) MarshalJSON() ([]byte, error) {
	...
	postVisitorsVisitorIDActionsActionKeyReverseOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostVisitorsVisitorIDActionsActionKeyReverseOKBodyAO1, errPostVisitorsVisitorIDActionsActionKeyReverseOKBodyAO1 := jsonutils.WriteJSON(dataPostVisitorsVisitorIDActionsActionKeyReverseOKBodyAO1)
