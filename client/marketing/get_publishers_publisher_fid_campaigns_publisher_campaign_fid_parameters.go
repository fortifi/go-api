...
func NewGetPublishersPublisherFidCampaignsPublisherCampaignFidParams() *GetPublishersPublisherFidCampaignsPublisherCampaignFidParams {
	return NewGetPublishersPublisherFidCampaignsPublisherCampaignFidParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetPublishersPublisherFidCampaignsPublisherCampaignFidParams].
