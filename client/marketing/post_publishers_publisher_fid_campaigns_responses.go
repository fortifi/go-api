...
func (o *PostPublishersPublisherFidCampaignsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostPublishersPublisherFidCampaignsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postPublishersPublisherFidCampaignsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostPublishersPublisherFidCampaignsOKBodyAO1); err != nil {
		return err
	}
...
func (o PostPublishersPublisherFidCampaignsOKBody) MarshalJSON() ([]byte, error) {
	...
	postPublishersPublisherFidCampaignsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostPublishersPublisherFidCampaignsOKBodyAO1, errPostPublishersPublisherFidCampaignsOKBodyAO1 := jsonutils.WriteJSON(dataPostPublishersPublisherFidCampaignsOKBodyAO1)
