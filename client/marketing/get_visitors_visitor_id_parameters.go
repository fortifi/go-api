...
func NewGetVisitorsVisitorIDParams() *GetVisitorsVisitorIDParams {
	return NewGetVisitorsVisitorIDParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetVisitorsVisitorIDParams].
