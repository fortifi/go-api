...
func (o *GetVisitorsVisitorIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetVisitorsVisitorIDOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getVisitorsVisitorIDOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetVisitorsVisitorIDOKBodyAO1); err != nil {
		return err
	}
...
func (o GetVisitorsVisitorIDOKBody) MarshalJSON() ([]byte, error) {
	...
	getVisitorsVisitorIDOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetVisitorsVisitorIDOKBodyAO1, errGetVisitorsVisitorIDOKBodyAO1 := jsonutils.WriteJSON(dataGetVisitorsVisitorIDOKBodyAO1)
