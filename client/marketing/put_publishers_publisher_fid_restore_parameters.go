...
func NewPutPublishersPublisherFidRestoreParams() *PutPublishersPublisherFidRestoreParams {
	return NewPutPublishersPublisherFidRestoreParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutPublishersPublisherFidRestoreParams].
