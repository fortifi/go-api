...
func (o *PostPublishersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostPublishersOK) Error() string {
	...
	return fmt.Sprintf("[POST /publishers][%d] postPublishersOK %s", 200, payload)
}
...
func (o *PostPublishersDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /publishers][%d] PostPublishers default %s", o._statusCode, payload)
}
...
func (o *PostPublishersOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postPublishersOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostPublishersOKBodyAO1); err != nil {
		return err
	}
...
func (o PostPublishersOKBody) MarshalJSON() ([]byte, error) {
	...
	postPublishersOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostPublishersOKBodyAO1, errPostPublishersOKBodyAO1 := jsonutils.WriteJSON(dataPostPublishersOKBodyAO1)
