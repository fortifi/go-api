...
func NewGetVisitorsVisitorIDPixelsParams() *GetVisitorsVisitorIDPixelsParams {
	return NewGetVisitorsVisitorIDPixelsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetVisitorsVisitorIDPixelsParams].
