...
func (o *PostVisitorsVisitorIDActionsActionKeyOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postVisitorsVisitorIDActionsActionKeyOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostVisitorsVisitorIDActionsActionKeyOKBodyAO1); err != nil {
		return err
	}
...
func (o PostVisitorsVisitorIDActionsActionKeyOKBody) MarshalJSON() ([]byte, error) {
	...
	postVisitorsVisitorIDActionsActionKeyOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostVisitorsVisitorIDActionsActionKeyOKBodyAO1, errPostVisitorsVisitorIDActionsActionKeyOKBodyAO1 := jsonutils.WriteJSON(dataPostVisitorsVisitorIDActionsActionKeyOKBodyAO1)
