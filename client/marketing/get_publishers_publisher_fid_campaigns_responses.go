...
func (o *GetPublishersPublisherFidCampaignsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetPublishersPublisherFidCampaignsOK) Error() string {
	...
	return fmt.Sprintf("[GET /publishers/{publisherFid}/campaigns][%d] getPublishersPublisherFidCampaignsOK %s", 200, payload)
}
...
func (o *GetPublishersPublisherFidCampaignsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /publishers/{publisherFid}/campaigns][%d] GetPublishersPublisherFidCampaigns default %s", o._statusCode, payload)
}
...
func (o *GetPublishersPublisherFidCampaignsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getPublishersPublisherFidCampaignsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetPublishersPublisherFidCampaignsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetPublishersPublisherFidCampaignsOKBody) MarshalJSON() ([]byte, error) {
	...
	getPublishersPublisherFidCampaignsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetPublishersPublisherFidCampaignsOKBodyAO1, errGetPublishersPublisherFidCampaignsOKBodyAO1 := jsonutils.WriteJSON(dataGetPublishersPublisherFidCampaignsOKBodyAO1)
