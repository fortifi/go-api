...
func (o *GetPublishersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetPublishersOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getPublishersOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetPublishersOKBodyAO1); err != nil {
		return err
	}
...
func (o GetPublishersOKBody) MarshalJSON() ([]byte, error) {
	...
	getPublishersOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetPublishersOKBodyAO1, errGetPublishersOKBodyAO1 := jsonutils.WriteJSON(dataGetPublishersOKBodyAO1)
