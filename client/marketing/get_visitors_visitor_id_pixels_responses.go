...
func (o *GetVisitorsVisitorIDPixelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetVisitorsVisitorIDPixelsOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getVisitorsVisitorIDPixelsOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetVisitorsVisitorIDPixelsOKBodyAO1); err != nil {
		return err
	}
...
func (o GetVisitorsVisitorIDPixelsOKBody) MarshalJSON() ([]byte, error) {
	...
	getVisitorsVisitorIDPixelsOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetVisitorsVisitorIDPixelsOKBodyAO1, errGetVisitorsVisitorIDPixelsOKBodyAO1 := jsonutils.WriteJSON(dataGetVisitorsVisitorIDPixelsOKBodyAO1)
