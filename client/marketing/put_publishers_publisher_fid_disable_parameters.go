...
func NewPutPublishersPublisherFidDisableParams() *PutPublishersPublisherFidDisableParams {
	return NewPutPublishersPublisherFidDisableParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutPublishersPublisherFidDisableParams].
