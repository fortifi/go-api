...
func (o *GetReasonsGroupsReasonGroupFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetReasonsGroupsReasonGroupFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getReasonsGroupsReasonGroupFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetReasonsGroupsReasonGroupFidOKBodyAO1); err != nil {
		return err
	}
...
func (o GetReasonsGroupsReasonGroupFidOKBody) MarshalJSON() ([]byte, error) {
	...
	getReasonsGroupsReasonGroupFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetReasonsGroupsReasonGroupFidOKBodyAO1, errGetReasonsGroupsReasonGroupFidOKBodyAO1 := jsonutils.WriteJSON(dataGetReasonsGroupsReasonGroupFidOKBodyAO1)
