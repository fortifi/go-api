...
func NewPostCustomersCustomerFidPaymentMethodsCreatePendingParams() *PostCustomersCustomerFidPaymentMethodsCreatePendingParams {
	return NewPostCustomersCustomerFidPaymentMethodsCreatePendingParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostCustomersCustomerFidPaymentMethodsCreatePendingParams].
