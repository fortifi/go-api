...
func (o *PostPresetChatReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostPresetChatOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postPresetChatOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostPresetChatOKBodyAO1); err != nil {
		return err
	}
...
func (o PostPresetChatOKBody) MarshalJSON() ([]byte, error) {
	...
	postPresetChatOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostPresetChatOKBodyAO1, errPostPresetChatOKBodyAO1 := jsonutils.WriteJSON(dataPostPresetChatOKBodyAO1)
