...
func NewPostPresetChatParams() *PostPresetChatParams {
	return NewPostPresetChatParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostPresetChatParams].
