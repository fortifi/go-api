...
func NewDeleteDeviceHardwareIDParams() *DeleteDeviceHardwareIDParams {
	return NewDeleteDeviceHardwareIDParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteDeviceHardwareIDParams].
