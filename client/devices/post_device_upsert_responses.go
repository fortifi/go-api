...
func (o *PostDeviceUpsertReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PostDeviceUpsertOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &postDeviceUpsertOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataPostDeviceUpsertOKBodyAO1); err != nil {
		return err
	}
...
func (o PostDeviceUpsertOKBody) MarshalJSON() ([]byte, error) {
	...
	postDeviceUpsertOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataPostDeviceUpsertOKBodyAO1, errPostDeviceUpsertOKBodyAO1 := jsonutils.WriteJSON(dataPostDeviceUpsertOKBodyAO1)
