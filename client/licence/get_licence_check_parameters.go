...
func NewGetLicenceCheckParams() *GetLicenceCheckParams {
	return NewGetLicenceCheckParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetLicenceCheckParams].
