...
func (o *GetLicenceCheckReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetLicenceCheckOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getLicenceCheckOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetLicenceCheckOKBodyAO1); err != nil {
		return err
	}
...
func (o GetLicenceCheckOKBody) MarshalJSON() ([]byte, error) {
	...
	getLicenceCheckOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetLicenceCheckOKBodyAO1, errGetLicenceCheckOKBodyAO1 := jsonutils.WriteJSON(dataGetLicenceCheckOKBodyAO1)
