...
func (o *GetAdvertisersAdvertiserFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetAdvertisersAdvertiserFidOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getAdvertisersAdvertiserFidOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetAdvertisersAdvertiserFidOKBodyAO1); err != nil {
		return err
	}
...
func (o GetAdvertisersAdvertiserFidOKBody) MarshalJSON() ([]byte, error) {
	...
	getAdvertisersAdvertiserFidOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetAdvertisersAdvertiserFidOKBodyAO1, errGetAdvertisersAdvertiserFidOKBodyAO1 := jsonutils.WriteJSON(dataGetAdvertisersAdvertiserFidOKBodyAO1)
