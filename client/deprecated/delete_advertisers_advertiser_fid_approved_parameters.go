...
func NewDeleteAdvertisersAdvertiserFidApprovedParams() *DeleteAdvertisersAdvertiserFidApprovedParams {
	return NewDeleteAdvertisersAdvertiserFidApprovedParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteAdvertisersAdvertiserFidApprovedParams].
