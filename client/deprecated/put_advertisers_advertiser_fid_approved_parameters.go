...
func NewPutAdvertisersAdvertiserFidApprovedParams() *PutAdvertisersAdvertiserFidApprovedParams {
	return NewPutAdvertisersAdvertiserFidApprovedParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutAdvertisersAdvertiserFidApprovedParams].
