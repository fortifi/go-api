...
func (o *GetAdvertisersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetAdvertisersOK) Error() string {
	...
	return fmt.Sprintf("[GET /advertisers][%d] getAdvertisersOK %s", 200, payload)
}
...
func (o *GetAdvertisersDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /advertisers][%d] GetAdvertisers default %s", o._statusCode, payload)
}
...
func (o *GetAdvertisersOKBody) UnmarshalJSON(raw []byte) error {
	...
	if err := jsonutils.ReadJSON(raw, &getAdvertisersOKBodyAO0); err != nil {
		return err
	}
	...
	if err := jsonutils.ReadJSON(raw, &dataGetAdvertisersOKBodyAO1); err != nil {
		return err
	}
...
func (o GetAdvertisersOKBody) MarshalJSON() ([]byte, error) {
	...
	getAdvertisersOKBodyAO0, err := jsonutils.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	...
	jsonDataGetAdvertisersOKBodyAO1, errGetAdvertisersOKBodyAO1 := jsonutils.WriteJSON(dataGetAdvertisersOKBodyAO1)
