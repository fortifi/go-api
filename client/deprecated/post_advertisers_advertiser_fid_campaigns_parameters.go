...
func NewPostAdvertisersAdvertiserFidCampaignsParams() *PostAdvertisersAdvertiserFidCampaignsParams {
	return NewPostAdvertisersAdvertiserFidCampaignsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostAdvertisersAdvertiserFidCampaignsParams].
