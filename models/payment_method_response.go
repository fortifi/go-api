...
func (m *PaymentMethodResponse) validateLastChallengeTime(formats strfmt.Registry) error {
	...
	if typeutils.IsZero(m.LastChallengeTime) { // not required
		return nil
	}
...
func (m *PaymentMethodResponse) validateLastIdentifyTime(formats strfmt.Registry) error {
	...
	if typeutils.IsZero(m.LastIdentifyTime) { // not required
		return nil
	}
...
func (m *PaymentMethodResponse) validateLastSuccessChallengeTime(formats strfmt.Registry) error {
	...
	if typeutils.IsZero(m.LastSuccessChallengeTime) { // not required
		return nil
	}
...
func (m *PaymentMethodResponse) validateLockExpiresAt(formats strfmt.Registry) error {
	...
	if typeutils.IsZero(m.LockExpiresAt) { // not required
		return nil
	}
...
func (m *PaymentMethodResponse) validateValidFromDate(formats strfmt.Registry) error {
	...
	if typeutils.IsZero(m.ValidFromDate) { // not required
		return nil
	}
